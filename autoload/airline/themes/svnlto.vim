" vim-airline companion theme of svnlto
...
let g:airline#themes#svnlto#palette = {}

let g:airline#themes#svnlto#palette.accents = {
      \ 'red': [ '#E5786D' , '' , 203 , '' , '' ],
      \ }

let g:airline#themes#svnlto#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#svnlto#palette.normal_modified = {
    \ 'airline_a': [ s:N1[0] , s:N1[1] , s:N1[2] , s:N1[3] , ''     ] ,
    \ 'airline_b': [ s:IM[0] , s:N2[1] , s:N2[2] , s:N2[3] , ''     ] ,
    \ 'airline_c': [ s:N3[0] , s:N3[1] , s:N3[2] , s:N3[3] , ''     ] }


let g:airline#themes#svnlto#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#svnlto#palette.insert_modified = {
    \ 'airline_a': [ s:I1[0] , s:I1[1] , s:I1[2] , s:I1[3] , ''     ] ,
    \ 'airline_b': [ s:I2[0] , s:I2[1] , s:I2[2] , s:I2[3] , ''     ] ,
    \ 'airline_c': [ s:I3[0] , s:I3[1] , s:I3[2] , s:I3[3] , ''     ] }


let g:airline#themes#svnlto#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#svnlto#palette.visual_modified = {
    \ 'airline_a': [ s:V1[0] , s:V1[1] , s:V1[2] , s:V1[3] , ''     ] ,
    \ 'airline_b': [ s:V2[0] , s:V2[1] , s:V2[2] , s:V2[3] , ''     ] ,
    \ 'airline_c': [ s:V3[0] , s:V3[1] , s:V3[2] , s:V3[3] , ''     ] }


let g:airline#themes#svnlto#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
let g:airline#themes#svnlto#palette.replace_modified = {
    \ 'airline_a': [ s:R1[0] , s:R1[1] , s:R1[2] , s:R1[3] , ''     ] ,
    \ 'airline_b': [ s:R2[0] , s:R2[1] , s:R2[2] , s:R2[3] , ''     ] ,
    \ 'airline_c': [ s:R3[0] , s:I3[1] , s:R3[2] , s:R3[3] , ''     ] }


let g:airline#themes#svnlto#palette.insert_paste = {
    \ 'airline_a': [ s:I1[0] , s:PA[0] , s:I1[2] , s:PA[1] , ''     ] ,
    \ 'airline_b': [ s:PA[0] , s:IM[0] , s:PA[1] , s:IM[1] , ''     ] ,
    \ 'airline_c': [ s:PA[0] , s:N3[1] , s:PA[1] , s:N3[3] , ''     ] }


let g:airline#themes#svnlto#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
" let g:airline#themes#svnlto#palette.inactive_modified = {
...
let g:airline#themes#svnlto#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
